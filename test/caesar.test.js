...
describe("caesar() test, written by Kwabena.", () => {
  ...
  it("should return false if shift amount less than -25", () => {
    const input = "thinkful";
    const shift = -26;
    const actual = caesar(input, shift, (encode = true));
  ...
  it("should wrap around to the front of the alphabet if shift pass z", () => {
